...
def diverse_greedy_select(sig_df, input_genes, max_terms=10, max_per_db=4):
    """Greedy set cover with database diversity constraint"""
...
def build_cnet(selected_terms, title, outpath, input_set=None):
    """Build cnet plot with proper LFC coloring"""
    G = nx.Graph()
...
# ============================================================
# REBUILD ALL CNETS WITH DATABASE DIVERSITY
# ============================================================
os.makedirs('final_plots', exist_ok=True)

# 1. CONSENSUS-BASED CNETS (all genes → enrichment → diverse selection)
