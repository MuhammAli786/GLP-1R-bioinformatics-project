"""
Shared style constants for the cnet plots: colours, sizes, fonts, layout
parameters, and enrichment-library metadata.
"""
# Colorbar / log2FC
VMAX = 2.0                          
...
# Gene nodes
GENE_MIN_SIZE = 80                   # Scatter size for degree-1 genes
GENE_DEGREE_SCALE = 40               # Added per degree
