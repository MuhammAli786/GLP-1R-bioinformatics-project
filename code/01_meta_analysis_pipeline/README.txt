...
11, 12. Accession 1 is excluded from this analysis. Accession 7 (lumbar
...
----------------------------------------------------------------
The three Illumina GPL6885 microarray datasets were
...
"Gene symbol" field GEO2R uses with AnnotGPL=TRUE). Contrasts:
  ...
  GSE39586 (Acc12): glp vs nORM, using the sample
...
THICKER edges; gene nodes coloured by mean log2FC,
...
PENDING / EXCLUDED
------------------
EXCLUDED: all Accession 1 groups.
